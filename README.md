...
- Дарга эрхээр `/report` командыг дарж товчлуурын сонголтоор (Өнөөдөр, Сүүлийн 7 хоног, Энэ сар, Өнгөрсөн сар, Хугацаа сонгох) тайлан (нийт дуудлага, бүтцийн нэгж, асуудлын төрөл, төлөв) авах боломжтой
- Менежер эрхээр `/add_employee` командаар ажилтны код, овог нэр, бүтцийн нэгжийг нэмж/шинэчилж болно
...
- Дуудлага хүлээн авах ажиллагаа ажлын өдрүүдийн 09:00-18:00 (Улаанбаатарын цаг) хооронд нээлттэй бөгөөд бусад цагт бот "Уучлаарай, ажлын цаг дууссан байна" гэж мэдэгдэнэ
- Дарга эрхээр `/report` командаар тайлан (нийт дуудлага, бүтцийн нэгж, асуудлын төрөл, төлөв) авах боломжтой
- Менежер эрхээр `/add_employee` командаар ажилтны код, овог нэр, бүтцийн нэгжийг нэмж/шинэчилж болно
- Дарга эрхтэйгээр `/assign_call ДУУДЛАГЫН_ID ИНЖЕНЕР_НЭР` командаар дуудлагыг инженерүүдийн аль нэгэнд гар аргаар оноож болно
- Дуудлага хүлээн авах ажиллагаа ажлын өдрүүдийн 09:00-18:00 цагийн хооронд нээлттэй бөгөөд бусад цагт бот "Уучлаарай, ажлын цаг дууссан байна" гэж мэдэгдэнэ

> ℹ️ **Ажилтны бүртгэл нэмэх**: Дарга эрхтэй хэрэглэгч `/add_employee` командаар ажилтны код, овог нэр, бүтцийн нэгжийг бүртгэнэ. Нэр ба бүтцийн нэгжийг `;` тэмдэгтээр салгана. Жишээ нь:
>
> ```
> /add_employee IT-123 Бат Болд; Мэдээлэл технологийн төв
> ```
...
2. Төслийн үндсэн хавтас дотор байрлах `.env.example`-ийг `cp .env.example .env` гэж хуулж, үүссэн `.env` файлыг өөрийн
   тохиргооны утгуудаар шинэчилнэ. Бот ажиллах болгонд төсөлтэй ижил түвшний `.env` файл автоматаар уншигдана:
   ...
   Linux/MacOS дээр жишээ тохиргоо (`.env` файл):
...
Бот ажиллаж эхэлсний дараа хэрэглэгчид `/start` командаар харилцах боломжтой болно. Дарга эрхтэй хэрэглэгч `/report` командаар товчлуурын сонголтоор тайлан харна.

> ℹ️ **Ажлын цагийн хязгаарлалт**: `/start` командаар дуудлага өгөх боломж зөвхөн 09:00-18:00 (Улаанбаатарын цаг) хооронд нээлттэй. Ажлын бус үед бот "Уучлаарай, ажлын цаг дууссан байна. Бид 09:00-18:00 цагийн хооронд дуудлага хүлээн авна." гэж мэдээлнэ.
> ℹ️ **Ажлын цагийн хязгаарлалт**: `/start` командаар дуудлага өгөх боломж зөвхөн 09:00-18:00 цагийн хооронд нээлттэй. Ажлын бус үед бот "Уучлаарай, ажлын цаг дууссан байна. Бид 09:00-18:00 цагийн хооронд дуудлага хүлээн авна." гэж мэдээлнэ.
